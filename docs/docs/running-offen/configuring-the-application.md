...
The language the application will use when displaying user facing text. Right now, `en` (English), `de` (German) and `fr` (French) are supported. In case you want to contribute to Offen by adding a new language, [we'd love to hear from you][email].
