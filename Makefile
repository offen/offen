...
update:
	...
	@docker compose run --rm script pnpm install --frozen-lockfile
	@docker compose run --rm vault pnpm install --frozen-lockfile
	@docker compose run --rm auditorium pnpm install --frozen-lockfile
