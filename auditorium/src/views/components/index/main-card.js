    ...
    dataHandled = (
      <Fragment>
        <Paragraph class='mt0 mb1'>
          {__('Your usage data is encrypted end-to-end. It will be automatically deleted after 6 months. <a href="/auditorium/" class="%s">You can delete your usage data yourself at any time in the Auditorium.</a>', 'b link dim dark-green')}
        </Paragraph>
      </Fragment>
    )
  } else {
