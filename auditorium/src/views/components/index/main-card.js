...
module.exports = (props) => {
  ...
  if (props.consentStatus === 'allow') {
    mainQuestion = (
      <Fragment>
        <Headline level={3} class='f5 b mt0 mb1'>
          {__('How can I review and delete my usage data or opt out?')}
        </Headline>
        <Paragraph class='mt0 mb4'>
          {__('Go to the <a href="%s" class="%s">Auditorium.</a>', '/auditorium/', 'link dim dark-green')}
        </Paragraph>
      </Fragment>
    )
    dataHandled = (
      <Fragment>
        <Paragraph class='mt0 mb1'>
          {__('Your usage data is encrypted end-to-end. It will be automatically deleted after 6 months. You can delete your usage data yourself at any time in the <a href="/auditorium/" class="%s">Auditorium.</a>', 'link dim dark-green')}
        </Paragraph>
      </Fragment>
    )
  } else {
    mainQuestion = (
      <Fragment>
        ...
        <Paragraph class='mt0 mb4'>
          {__('For data to be collected you need to opt in first. You can do this in the <a href="%s" class="%s">consent banner.</a>', '#consent-banner', 'link dim dark-green')}
        </Paragraph>
      </Fragment>
    )
    dataHandled = (
      <Fragment>
        <Paragraph class='mt0 mb1'>
          {__('Your usage data is encrypted end-to-end. It will be automatically deleted after 6 months. You can delete your usage data yourself at any time.')}
        </Paragraph>
      </Fragment>
    )
  }
