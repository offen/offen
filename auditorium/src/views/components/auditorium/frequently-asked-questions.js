      ...
      <div class='flex flex-column flex-row-ns w-100'>
        <div class='w-100 w-50-ns mr2-ns mb4 mb0-ns'>
          ...
          <Paragraph class='mt0 mb1'>
            {__('Your usage data is encrypted end-to-end. It will be automatically deleted within 6 months. You can delete your usage data yourself at any time in the privacy panel.')}
          </Paragraph>
        </div>
