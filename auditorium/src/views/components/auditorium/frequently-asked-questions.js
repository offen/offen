    ...
    <div class='ph3 ph4-ns pv4 bg-black-05'>
      ...
      <div class='flex flex-column flex-row-ns w-100'>
        ...
        <div class='w-100 w-50-ns ml4-ns'>
          ...
          <Paragraph class='mt0 mb4'>
            {__('Yes, in particular cookies are used to store your decision about granting access to your usage data. If you opt in, we also use <a href="#terms-cookies" class="%s">cookies</a> to store a user and a session <a href="#terms-id" class="%s">ID</a> for you.', 'link dim dark-green', 'link dim dark-green')}
          </Paragraph>
          <Paragraph class='b mt0 mb1'>
            {__('How does it all work?')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
            {__('After opening a website where a <a href="#terms-offen-installation" class="%s">Offen installation</a> is active, you can explicitly opt in to the data collection and thereby help to improve the services you use. Only then you will be assigned a user and a session <a href="#terms-id" class="%s">ID</a> using a <a href="#terms-cookies" class="%s">cookie.</a> Offen handles these <a href="#terms-id" class="%s">IDs</a> in an unrecognizable form, i.e. no server will ever store this identifier.', 'link dim dark-green', 'link dim dark-green', 'link dim dark-green', 'link dim dark-green')}
          </Paragraph>
        </div>
      </div>
    </div>
