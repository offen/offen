    ...
    <div class='ph3 ph4-ns pv4 bg-black-05'>
      ...
      <div class='flex flex-column flex-row-ns w-100'>
        <div class='w-100 w-50-ns mr2-ns'>
          <Paragraph class='b mt0 mb1' id='terms-auditorium'>
            {__('Auditorium')}
          </Paragraph>
          ...
          <Paragraph class='b mt0 mb1' id='terms-offen-installation'>
          ...
          <Paragraph class='b mt0 mb1' id='terms-cookies'>
            {__('Cookies')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
          ...
          <Paragraph class='b mt0 mb1' id='terms-operator'>
            {__('Operator')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
            {__('Operators are the owners of <a href="#terms-offen-installation" class="%s">Offen installations.</a> Only after you opted in, your usage data of a website is collected. Operators than can view it for maximum 6 months.', 'link dim dark-green')}
          </Paragraph>
        </div>
        <div class='w-100 w-50-ns ml4-ns'>
          <Paragraph class='b mt0 mb1' id='terms-unique-user'>
            {__('Unique user')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
            {__('You are defined as a unique user after your opt in to data collection. To measure this, a <a href="#terms-cookies" class="%s">cookie</a> is used to assign a user <a href="#terms-id" class="%s">ID</a> to you.', 'link dim dark-green', 'link dim dark-green')}
          </Paragraph>
          <Paragraph class='b mt0 mb1' id='terms-unique-session'>
            {__('Unique session')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
          ...
          <Paragraph class='b mt0 mb1' id='terms-id'>
            {__('ID')}
          </Paragraph>
          <Paragraph class='mt0 mb4'>
